...
internal abstract class BreedingHistoryOfCattleModule {
    ...
    internal abstract fun contributeBreedingHistoryOfCattleFragment():
        BreedingHistoryOfCattleFragment
    ...
    internal abstract fun bindBreedingHistoryOfCattleViewModel(
        viewModel: BreedingHistoryOfCattleViewModel
    ): ViewModel
}
